...
namespace refactor {
    ...
    struct BoundingBox {
        ...
        using particle_type = particle_type_template<dimension>;
        ...
        position_type get_rasteriser(grid_id_type n_divisions)
        {
            ...
            for ( dim_type i = 0; i < dimension; ++i ) {
        ...
        void print_info() const
        {
            ...
            for ( int i = 0; i < dimension; ++i ) std::cout << Min[i] << ",";
            std::cout << "), (";
            for ( int i = 0; i < dimension; ++i ) std::cout << Max[i] << ",";
            std::cout << ")]" << std::endl;
        }
