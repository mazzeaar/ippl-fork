#ifndef MORTON_ENCODER_DEVICE_H
#define MORTON_ENCODER_DEVICE_H
...
namespace ippl {
    ...
    KOKKOS_INLINE_FUNCTION
        ...
        MortonDevice(const MortonDevice&)            = default;
        MortonDevice& operator=(const MortonDevice&) = default;
        MortonDevice(MortonDevice&&)                 = default;
        MortonDevice& operator=(MortonDevice&&)      = default;
         ...
         */
        KOKKOS_INLINE_FUNCTION
        morton_code encode(const real_coordinate& coordinate,
         ...
         */
        KOKKOS_INLINE_FUNCTION
        morton_code encode(const grid_coordinate& coordinate, const size_t depth) const;
         ...
         */
        KOKKOS_INLINE_FUNCTION
        grid_coordinate decode(morton_code code) const;
         ...
         */
        KOKKOS_INLINE_FUNCTION
        size_t get_depth(morton_code code) const;
         ...
         */
        KOKKOS_INLINE_FUNCTION
        morton_code get_parent(morton_code code) const;
         ...
         */
        KOKKOS_INLINE_FUNCTION
        Kokkos::View<morton_code*> get_children(morton_code code) const;
         ...
         */
        KOKKOS_INLINE_FUNCTION
        Kokkos::View<morton_code*> get_siblings(morton_code code) const;
         ...
         */
        KOKKOS_INLINE_FUNCTION
        morton_code get_nearest_common_ancestor(morton_code code_a,
         ...
         */
        KOKKOS_INLINE_FUNCTION
        morton_code get_step_size(morton_code code) const;
    ...
    private:
         ...
         */
        KOKKOS_INLINE_FUNCTION
        morton_code spread_coords(grid_t coord) const;
    };

}  // namespace ippl

#include "MortonHelperDevice.hpp"
