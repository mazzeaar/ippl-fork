#include "MortonHelperDevice.h"

namespace ippl {

    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::encode(const real_coordinate& coordinate, const real_coordinate& rasterizer, const size_t depth) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::encode(const grid_coordinate& coordinate, const size_t depth) const
    {
        morton_code code = 0;
        for ( size_t i = 0; i < Dim; ++i ) {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    MortonDevice<Dim>::grid_coordinate MortonDevice<Dim>::decode(morton_code code) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    size_t MortonDevice<Dim>::get_depth(morton_code code) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::get_parent(morton_code code) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    Kokkos::View<morton_code*> MortonDevice<Dim>::get_children(morton_code code) const
    {
        ...
        Kokkos::View<morton_code*> vec("children", n_children);

        Kokkos::parallel_for(n_children, KOKKOS_LAMBDA(const size_t i) {
            vec(i) = first_child + (i * step);
        });
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    Kokkos::View<morton_code*> MortonDevice<Dim>::get_siblings(morton_code code) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    bool MortonDevice<Dim>::is_descendant(morton_code child, morton_code parent) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    bool MortonDevice<Dim>::is_ancestor(morton_code child, morton_code parent) const
    {
        return is_descendant(child, parent);
    }

    template <size_t Dim>
    inline morton_code MortonDevice<Dim>::get_first_child(morton_code code) const
    {
        /*
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::get_last_child(morton_code code) const
    {
        /*
        std::string error = std::string("RANK: ") + std::to_string(Comm->rank()).c_str()
                            + std::string(" can't get the first child at the deepest level");
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::get_first_descendant(morton_code code, const size_t level) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::get_last_descendant(morton_code code, const size_t level) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::get_deepest_first_descendant(morton_code code) const
    {
        return get_first_descendant(code, max_depth);
    }

    template <size_t Dim>
    inline morton_code MortonDevice<Dim>::get_deepest_last_descendant(morton_code code) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::get_nearest_common_ancestor(morton_code code_a, morton_code code_b) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::get_step_size(morton_code code) const
    {
    ...
    template <size_t Dim>
    KOKKOS_INLINE_FUNCTION
    morton_code MortonDevice<Dim>::spread_coords(grid_t coord) const
    {
        morton_code res = 0;
