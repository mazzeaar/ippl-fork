...
#pragma region paralell construction
         ...
         **/
        Kokkos::View<morton_code*> block_partition(morton_code min_octant, morton_code max_octant, std::function<Kokkos::View<size_t*>(Kokkos::View<morton_code*>)> weight_function);
