...
namespace ippl {
    template <size_t Dim>
    Kokkos::View<morton_code*,Kokkos::HostSpace::memory_space> OrthoTree<Dim>::complete_region(morton_code code_a,
        morton_code code_b) {
        ...
        if (code_a >= code_b) {
            Kokkos::View<morton_code*,Kokkos::HostSpace::memory_space> min_lin_tree_empty("algo2::complete_region::empty min_lin_tree", 0);
        ...
        Kokkos::View<morton_code*,Kokkos::HostSpace::memory_space> min_lin_tree("algo2::complete_region::min_lin_tree", estimated_size);
        size_t idx = 0;
