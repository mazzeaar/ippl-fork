                    ...
                    std::for_each(
                        ...
                        [&, this](const morton_code current_key) {
                            ...
                            if (this->morton_helper.get_depth(neighbor) < depth - 1
                                ...
                                //if(std::find(T(neighbor_idx).begin(), T(neighbor_idx).end(), this->morton_helper.get_parent_at_level(current_key, depth-1)) == T(neighbor_idx).end()){

                                    T(neighbor_idx).push_back(this->morton_helper.get_parent_at_level(current_key, depth - 1));
                                //}
                            }
                        });
                });
